...
function PageModal({ setShowForm }) {
  ...
  return createPortal(
    <AnimatePresence>
      <motion.section
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed top-0 left-0 w-full bg-emerald-900/80 z-[100] overflow-hidden min-h-screen flex items-center justify-center"
      >
